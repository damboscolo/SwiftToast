#
# Be sure to run `pod lib lint SwiftToast.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'SwiftToast'
  s.version          = '0.1.0'
  s.summary          = 'This is a simple SwiftToast.'
...
TODO: Add long description of the pod here.
  ...
  s.resources = ["images/*.png", "classes/SwiftToastView.xib"]

  # s.resource_bundles = {
  #   'SwiftToast' => ['SwiftToast/Classes/SwiftToastView.xib']
  #}
